...
func ParseTicket(input any) (Ticket, error) {
	...
	return invalidTicket, fmt.Errorf("failed to parse %T as Ticket", input)
}
...
func _() {
	...
	_ = [1]struct{}{}[unknown]
	_ = [1]struct{}{}[created-1]
	_ = [1]struct{}{}[pending-2]
	_ = [1]struct{}{}[approval_pending-3]
	_ = [1]struct{}{}[approval_accepted-4]
	_ = [1]struct{}{}[rejected-5]
	_ = [1]struct{}{}[completed-6]
}
