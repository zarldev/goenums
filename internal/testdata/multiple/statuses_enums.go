...
// MatchStatus dispatches to the matcher method for the given enum value.
// The StatusMatcher interface provides compile-time exhaustiveness: when enum
...
func MatchStatus(en Status, matcher StatusMatcher) error {
	if matcher == nil {
		return fmt.Errorf("nil StatusMatcher")
	}
	switch en {
