// DO NOT EDIT.
// code generated by goenums 'v0.3.8' at 2025-05-03 00:10:50.
...
// the invalidOrder value and an error.
func ParseOrder(a any) (Order, error) {
	...
	if res == invalidOrder {
		return res, fmt.Errorf("failed to parse Order value - invalid input: %v", a)
	}
	return res, nil
}
...
var ordersIdx = [...]uint16{0, 0, 0, 0, 0, 0, 0, 0, 7, 15, 25, 38, 45, 54, 63}
...
func (i order) String() string {
	if i < 7 || i >= order(len(ordersIdx)-1) {
