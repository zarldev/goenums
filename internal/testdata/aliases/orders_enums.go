...
func ParseOrder(input any) (Order, error) {
	...
	return invalidOrder, fmt.Errorf("invalid value %v", input)
}
...
func _() {
	...
	_ = [1]struct{}{}[created]
	_ = [1]struct{}{}[approved-1]
	_ = [1]struct{}{}[processing-2]
	_ = [1]struct{}{}[readyToShip-3]
	_ = [1]struct{}{}[shipped-4]
	_ = [1]struct{}{}[delivered-5]
	_ = [1]struct{}{}[cancelled-6]
}
