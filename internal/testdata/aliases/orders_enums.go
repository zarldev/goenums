// Code generated by goenums 'v0.3.6' at 2025-04-18T23:18:01+01:00. DO NOT EDIT.
...
var (
	_ordersNameMap = map[string]Order{
		...
		"readyToShip": Orders.READYTOSHIP, // Primary alias
...
const _orders_name = "createdapprovedprocessingreadyToShipshippeddeliveredcancelled"

var _orders_index = [...]uint16{0, 0, 0, 0, 0, 0, 0, 0, 7, 15, 25, 36, 43, 52, 61}
...
func (i order) String() string {
	if i < 7 || i >= order(len(_orders_index)-1) {
