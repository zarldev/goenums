...
// using the command:
// goenums ../internal/testdata/validation-strings/status.go
...
// ExhaustiveStatuss calls the provided function once for each valid Status value.
// This is useful for switch statement exhaustiveness checking and for processing all enum values.
// Example usage:
// ```
//
//	ExhaustiveStatuss(func(x Status) {
//	    switch x {
//	    case Statuses.VALUE1:
//	        // handle VALUE1
//	    }
//	})
//
