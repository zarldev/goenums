// DO NOT EDIT.
// code generated by goenums 'v0.3.7' at 2025-05-02 16:27:46.
...
func (p Sale) MarshalYAML() (interface{}, error) {
	return p.String(), nil
}
...
func (p *Sale) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var s string
	if err := unmarshal(&s); err != nil {
		return err
	}
	newp, err := ParseSale([]byte(s))
	if err != nil {
		return err
	}
	*p = newp
...
var salesIdx = [...]uint16{0, 0, 5, 15, 21, 29}
...
func (i sale) String() string {
	if i < 1 || i >= sale(len(salesIdx)-1) {
		return "sales(" + (strconv.FormatInt(int64(i), 10) + ")")
	}
	return salesName[salesIdx[i]:salesIdx[i+1]]
}
