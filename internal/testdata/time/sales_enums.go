// code generated by goenums 'v0.4.0' at May 28 03:10:25. DO NOT EDIT.
//
...
func (s Sale) MarshalYAML() (any, error) {
	return s.String(), nil
}
...
func (s *Sale) UnmarshalYAML(ctx context.Context, f func(any) error) error {
	select {
	case <-ctx.Done():
		return ctx.Err()
	default:
