// DO NOT EDIT.
// code generated by goenums 'v0.3.7' at 2025-05-02 16:29:18.
...
// MarshalYAML implements the gopkg.in/yaml.v2::yaml.Marshaler interface for DiscountType.
// It returns the YAML string representation of the enum.
func (p DiscountType) MarshalYAML() (interface{}, error) {
	return p.String(), nil
}

// UnmarshalYAML implements the gopkg.in/yaml.v2::yaml.Unmarshaler interface for DiscountType.
// It supports unmarshaling from a YAML string representation of the enum.
func (p *DiscountType) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var s string
	if err := unmarshal(&s); err != nil {
		return err
	}
	newp, err := ParseDiscountType([]byte(s))
	if err != nil {
		return err
	}
	*p = newp
...
func (i discountTypes) String() string {
	if i < 1 || i >= discountTypes(len(discountTypesIdx)-1) {
