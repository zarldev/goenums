// DO NOT EDIT.
// code generated by goenums 'v0.4.1' at Jun 20 14:48:31.
//
...
func ParseStatus(input any) (Status, error) {
	...
	return invalidStatus, fmt.Errorf("invalid value %v", input)
}
...
func _() {
	...
	_ = [1]struct{}{}[failed-1]
	_ = [1]struct{}{}[passed-2]
	_ = [1]struct{}{}[skipped-3]
	_ = [1]struct{}{}[scheduled-4]
	_ = [1]struct{}{}[running-5]
	_ = [1]struct{}{}[booked-6]
}
