// code generated by goenums 'v0.4.0' at May 28 00:38:19. DO NOT EDIT.
//
...
// statusContainer is the container for all enum values.
...
func (s statusContainer) allSlice() []Status {
	return []Status{
		Statuses.FAILED,
		Statuses.PASSED,
		Statuses.SKIPPED,
...
// This method is useful for iterating over all enum values in a loop.
func (s statusContainer) All() iter.Seq[Status] {
...
// statusNameMap is a map of enum values to their Status representation
...
func (p Status) MarshalYAML() (any, error) {
	return p.String(), nil
}
...
func (p *Status) UnmarshalYAML(ctx context.Context, f func(any) error) error {
	select {
	case <-ctx.Done():
		return ctx.Err()
	default:
