...
// MarshalYAML implements the gopkg.in/yaml.v2::yaml.Marshaler interface for Status.
// It returns the YAML string representation of the enum.
func (p Status) MarshalYAML() (interface{}, error) {
	return p.String(), nil
}

// UnmarshalYAML implements the gopkg.in/yaml.v2::yaml.Unmarshaler interface for Status.
// It supports unmarshaling from a YAML string representation of the enum.
func (p *Status) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var s string
	if err := unmarshal(&s); err != nil {
		return err
	}
	newp, err := ParseStatus([]byte(s))
	if err != nil {
		return err
	}
	*p = newp
...
func (i status) String() string {
	if i < 0 || i >= status(len(statusesIdx)-1) {
